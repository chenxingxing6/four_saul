    ...
    async.mapLimit(urls, 2, function(url, callback) {
        ...
        var data = {
            person: {
                ...
                member: update.obj.people.member == 0 ? '1' : update.obj.people.member,
                income: update.obj.people.income == 0 ? '1' : update.obj.people.income,
                assets: update.obj.people.assets == 0 ? '1' : update.obj.people.assets,
                work: update.obj.people.work,
                work_date: update.obj.people.work_date == 0 ? '1' : update.obj.people.work_date,
